...
run_date = str(sys.argv[1].split("-")[0])
print run_date
clean_date =str(datetime.strptime(run_date,'%Y%m%d'))
...
for feat in lyr:
    ...
    npo.description = \
        ...
        "<tr><td><b>Forecasted Overtopping Results from Model</b></td><td>"+str(clean_date.split(" ")[0])+"</td></tr>" \
        ...
        "</table>]]>"
        #"<img src='https://vfis.uvahydroinformatics.org/static/area_graph.png' height='100' width='300'>]]>"
    #npo.style.iconstyle.icon.href = \
        #'http://maps.google.com/mapfiles/kml/shapes/placemark_circle.png'

    if floodedby > 0.3:
        #npo.style.iconstyle.color = simplekml.Color.red
        npo.style.iconstyle.icon.href = 'https://vfis.uvahydroinformatics.org/static/red_MarkerF.png'
    elif 0 < floodedby <= 0.30:
        #npo.style.iconstyle.color = simplekml.Color.yellow
        npo.style.iconstyle.icon.href = 'https://vfis.uvahydroinformatics.org/static/yellow_MarkerF.png'
    else:
        npo.style.iconstyle.icon.href = 'https://vfis.uvahydroinformatics.org/static/small_green_circle.png'
